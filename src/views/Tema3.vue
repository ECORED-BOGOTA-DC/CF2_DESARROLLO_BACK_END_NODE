  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    .titulo-principal.color-acento-contenido(data-aos="flip-up")
      .titulo-principal__numero
        span 3
      h1 Construcción API
    p.mb-0(data-aos="fade-right") En este momento ya disponemos de las herramientas de #[i software] necesarias y los conceptos involucrados en la construcción de la API RESTful, ahora veamos los siguientes aspectos a tener en cuenta:
    Separador
    #t_3_1
    ...
    .row.justify-content-center.mb-5(data-aos="fade-right")
      ...
      .col-10.col-md-7.col-lg-3.mb-4.mb-lg-0
        .row.align-items-center
          ...
          .col.bg-c8(style="z-index: 1")
            .ps-4.py-2
              p.mb-0 #[b Listar todos los documentos.]
      .col-10.col-md-7.col-lg-3
        .row.align-items-center
          ...
          .col.bg-c8(style="z-index: 1")
            .ps-4.py-2
              p.mb-0 #[b Registrar un nuevo documento, etc.]
        ...
        AcordionA(tipo="a" clase-tarjeta="tarjeta tarjeta--verde")(data-aos="fade-down")
          ...
          .row(titulo="find()")
            .col-12
              ...
              p Algunos ejemplos de la utilización del find podrían ser los siguientes:
              .row
                .col-12.bg-c9
                  .p-4
    ...
    p.mb-5(data-aos="fade-down") Los parámetros utilizados en la consulta son obtenidos desde el #[i body] del objeto de tipo #[i request], es decir, que en el momento de hacer la solicitud del servicio se deberá hacer uso de un método de tipo POST o similar que acepte el envío de parámetros. Observe dicha figura:
    .row.bg-c7.mb-5(data-aos="fade-right")
      .col-12
        .px-5
          .titulo-sexto.color-acento-contenido.mb-5
    ...
    .row.align-items-center.mb-5
      ...
      .col-lg-8(data-aos="fade-left")
        ...
        p.mb-0 El parámetro del identificador debe ser capturado desde el #[i body] del objeto #[i request], lo que implica que la invocación de este servicio se realizará por medio de un método POST o similar que acepte el envío de parámetros en el cuerpo de la solicitud enviada al servidor. Dicha figura es:
    .row.bg-c7.mb-5(data-aos="fade-right")
      .col-12
        .px-5
          .titulo-sexto.color-acento-contenido.mb-5
