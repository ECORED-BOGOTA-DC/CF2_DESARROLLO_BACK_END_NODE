  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch.mb-5
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Generalidad de Node.js
        p.mb-4 Fortalecer algunos conceptos relacionados con Node.js requeridos para la construcción de una API RESTful, de acuerdo con los requisitos del cliente.
